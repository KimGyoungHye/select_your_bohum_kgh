...
public class BohumTest01 {
	/* Java 1.8 샘플 코드 */
	    public static void main(String[] args) throws IOException {
	        ...
	        urlBuilder.append("&" + URLEncoder.encode("title","UTF-8") + "=" + URLEncoder.encode("생보_일반현황_임직원 및 설계사 현황", "UTF-8")); /*생보_일반현황*/
	        urlBuilder.append("&" + URLEncoder.encode("basYm","UTF-8") + "=" + URLEncoder.encode("201603", "UTF-8")); /*기준년월*/
